...
//        GetEngine().LoadNamedTexture(TexturesInAnimation[i], "Resources/SpelResurser/Sprites/" + TexturesInAnimation[i]);
//    }
//}
//
...
//            SpelObjectet->GetComponent<SpriteRenderer>()->SpriteTexture = GetEngine().LoadNamedTexture(TexturesInAnimation[i], "SpelResurser/Sprites/" + TexturesInAnimation[i]);
//            break;
//        }
//    }
//    AnimationTimer += 1;
